...
# pts = [(40, 0), (40, 1280), (94, 570), (94, 707), (0, 0)]
# pts = [(570, 280), (710, 260), (10, 610), (1280, 630), (0, 0)]
pts = [(530, 290), (755, 290), (10, 610), (1280, 630), (0, 0)]
pointIndex = 0
AR = (740, 1280)
...
print(temp[0][0])
np.save("transform_matrix.npy", transformation_matrix)
cv2.circle(warped, tuple([int(i) for i in (temp[0][0])]), 1, (0, 255, 0), 1)
